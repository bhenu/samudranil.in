...
<link rel="stylesheet" href="https://samudranil-in.herokuapp.com/css/normalize.css" />
<link rel="stylesheet" href="https://samudranil-in.herokuapp.com/css/main.css" />
<link rel="stylesheet" href="https://samudranil-in.herokuapp.com/css/smartphone.css" />
<link href='https://fonts.googleapis.com/css?family=Ubuntu:300' rel='stylesheet' type='text/css'>
<script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script>

<?php if (!isset($_GET['page'])): ?>
    <script src="https://samudranil-in.herokuapp.com/scripts/swipe.js"></script>
    <script>
    $(function(){
...
<body>
  <div class="header">
    <a href="https://samudranil-in.herokuapp.com/index.php"><div id="logo"><img src="https://samudranil-in.herokuapp.com/images/logo_s.png" /></div></a>
    <div id="menu"></div>
  </div>
  <div class="menu-list">
        <a href="https://samudranil-in.herokuapp.com/">home</a>
        <a href="https://samudranil-in.herokuapp.com/albums/">albums</a>
        <a href="https://samudranil-in.herokuapp.com/blog/">blog</a>
        <a href="https://samudranil-in.herokuapp.com/about/">about</a>
  </div>
  <div class="content-area">
        ...
        <div id="recent-swipe" class="swipe" style='visibility: visible'>
            ...
            <?php
                ...
                foreach ($photos as $entry){
                        ...
                        echo "<a href='https://samudranil-in.herokuapp.com/photo/".$entry['photoid']."'><div class='recent-element'><img class='pics' alt='". $entry['title'] . "' src='" . $entry['url'] . "'/></div></a>";
                        $elem_counter += 1;
                        }
                echo "</div>";
    ...
    <div class="albums">
        ...
        <?php
            ...
            foreach ($albums as $entry) {
                ...
                echo "<a href=\"https://samudranil-in.herokuapp.com/albums/".$entry['albumid']."\"><div class='album-elements'>";
    ...
    <div class="blog-posts">
        ...
        foreach($Posts as $entry){
            ...
            echo "<h3><a href='https://samudranil-in.herokuapp.com/blog/".$entry['id']."'>".$entry['title']."</a></h3>";
            ...
            echo $entry['body'];
            echo "<a href='https://samudranil-in.herokuapp.com/blog/".$entry['id']."'><span style='font-weight: bold; display: block; text-align: right'>read on ..</span></a>";
            echo "</div>";
            }
            echo "<a href='https://samudranil-in.herokuapp.com/blog/'><h3 style='text-align: center'>visit the blog</h3></a>";
    ...
    <?php elseif(isset($_GET['page']) && isset($_GET['id']) && $_GET['page'] == 'albums'): ?>
        <div class="photos only">
            ...
            echo "<a href='https://samudranil-in.herokuapp.com/albums/'><h3>← all aubums</h3></a>";
            ...
            foreach ($photos as $entry){
                    ...
                    echo "<div class='photo-element'><a href='https://samudranil-in.herokuapp.com/photo/".$entry['photoid']."'><img class='pics' alt='". $entry['title'] . "' src='" . $entry['url'] . "'/></div></a>";
                    $elem_counter += 1;
                    }
            echo "</div>";
            ?>
    ...
    <div class='photo-container'>
        <?php
            ...
            echo "<a href='https://samudranil-in.herokuapp.com/albums/".$photo['albumid']."'><h3>← albums / " . $photo['albumtitle'] . "</h3></a>";
            echo "<img class=\"pics\" src=\"" . $photo['url'] . "\"/>";
            echo "<h2>".$photo['title']."</h2>";
            if($photo['prev']['id'] != null){
                echo "<a href='https://samudranil-in.herokuapp.com/photo/".$photo['prev']['id']."'><h3 style='float: left; margin-left: 5%'>← previous</h3></a>";
            }
            if($photo['next']['id'] != null){
                echo "<a href='https://samudranil-in.herokuapp.com/photo/".$photo['next']['id']."'><h3 style='float: right; margin-right: 5%'>next →</h3></a>";
            }
        ?>
    </div>
    <!-- blog main page -->
    ...
    <div class='blog-container'>
        ...
        if($offset){
            echo "<a href='https://samudranil-in.herokuapp.com/blog/page/".($offset - 1)."'><h3 style='float: right; margin-right: 5%'>newer →</h3></a>";
            }
        if(($total_posts - ($offset +1)*10) > 0){
            echo "<a href='https://samudranil-in.herokuapp.com/blog/page/".($offset + 1)."'><h3 style='float: left; margin-left: 5%'>← older</h3></a>";
        }
        ?>
    </div>
    <?php elseif(isset($_GET['page']) && $_GET['page'] == 'blog' && isset($_GET['id'])): ?>
    <div class='blog-container'>
        ...
        echo "</div>";
        ?>
        <a href="https://samudranil-in.herokuapp.com/blog"><h3>back to blog</h3></a>
    </div>
    <?php endif; ?>
  </div>
  <div class="footer">
      ...
      <div class='site-credits'>
          <a href='https://samudranil.heroku.com/credits'>site credits</a>
      </div>
  </div>
</body>
</html>
